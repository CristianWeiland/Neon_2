...
int imprime_4_chars_for(int cont,int desx[],int desy[],int cx[],int cy[],int xneon[],int yneon[],char** matriz,ALLEGRO_BITMAP** neons,ALLEGRO_BITMAP *chars,int *cor,bool *temneon,int njogadores, Pessoa *p)
{
